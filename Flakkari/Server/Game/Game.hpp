...
public: // Loaders
     ...
     */
    void loadSystems(std::unique_ptr<Engine::API::IRegistry> &registry, const std::string &sceneName, const std::string &sysName);
     ...
     */
    void loadEntityFromTemplate(std::unique_ptr<Engine::API::IRegistry> &registry, const nl_entity &entity, const nl_template &templates);
...
private:
    ...
    std::unordered_map<std::string /*sceneName*/, std::unique_ptr<Engine::API::IRegistry> /*content*/> _scenes; // Scenes of the game
};
